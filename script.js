// Database Senjata Nuklir Dunia (13 Bom Lengkap)
const nuclearBombs = [
  {
...
// Fungsi merender kartu ke DOM
function displayBombs(bombs) {
  const grid = document.getElementById("bombGrid");
  grid.innerHTML = ""; 

  if (bombs.length === 0) {
    grid.innerHTML = `<p style="grid-column: 1/-1; text-align: center; color: #72777d; padding: 20px;">Tidak ada data bom nuklir yang cocok.</p>`;
    return;
  }
...
// Render saat pertama kali aplikasi dibuka
